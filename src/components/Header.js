const Header = (props) => {
    ...
    return (
        <div className="header">
            <img src={"./image/Logo" + (!props.isDay ? "_night" : "") + ".png"} alt="SlamCoin Logo" className="logo" />
            <div className="options">
                ...
                {props.sideBarShow ? <div class="close" onClick={props.onClickSideBarShow}><i class="fas fa-times"></i></div> : ""}
